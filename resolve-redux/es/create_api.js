...
export var FetchError =
/*#__PURE__*/
function (_ApiError) {
  _inheritsLoose(FetchError, _ApiError);
...
/*#__PURE__*/
function (_ApiError2) {
  _inheritsLoose(HttpError, _ApiError2);
...
export var temporaryErrorHttpCodes = [408, // Request Timeout
...
var doFetch = function doFetch() {
  try {
    ...
    return unfetch.apply(void 0, arguments);
  }
};
...
var createApi = function createApi(_ref2) {
  ...
  function () {
    ...
    /*#__PURE__*/
    _regeneratorRuntime.mark(function _callee2(url, body) {
      var rootBasedUrl, options, jwtToken, response, responseJwtToken;
      return _regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              rootBasedUrl = getRootBasedUrl(origin, rootPath, url);
              options = {
                method: 'POST',
                headers: {
  ...
  return {
    loadViewModelState: function () {
      var _loadViewModelState = _asyncToGenerator(
      /*#__PURE__*/
    ...
    loadReadModelState: function () {
      var _loadReadModelState = _asyncToGenerator(
      /*#__PURE__*/
    ...
    getSubscribeAdapterOptions: function () {
      var _getSubscribeAdapterOptions = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee6(adapterName) {
        var response, result;
    ...
    request: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee7(_ref7) {
        var url, body;
