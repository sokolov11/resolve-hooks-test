...
function createViewModelsReducer(viewModels) {
  ...
  handlers[_action_types.LOAD_VIEWMODEL_STATE_REQUEST] = function (state, action) {
    ...
    return _objectSpread({}, state, (_objectSpread5 = {}, _objectSpread5[_constants.connectorMetaMap] = _objectSpread({}, state[_constants.connectorMetaMap], (_objectSpread2 = {}, _objectSpread2["" + viewModelName + aggregateIds + aggregateArgs] = {
      isLoading: true,
      isFailure: false
    }, _objectSpread2)), _objectSpread5[_constants.aggregateVersionsMap] = _objectSpread({}, state[_constants.aggregateVersionsMap], (_objectSpread3 = {}, _objectSpread3[key] = {}, _objectSpread3)), _objectSpread5[_constants.lastTimestampMap] = _objectSpread({}, state[_constants.lastTimestampMap], (_objectSpread4 = {}, _objectSpread4[key] = +Infinity, _objectSpread4)), _objectSpread5));
  };
  ...
  handlers[_action_types.LOAD_VIEWMODEL_STATE_SUCCESS] = function (state, action) {
    ...
    var key = "" + viewModelName + aggregateIds + aggregateArgs;
    return _objectSpread({}, state, (_objectSpread10 = {}, _objectSpread10[viewModelName] = _objectSpread({}, state[viewModelName] || {}, (_objectSpread7 = {}, _objectSpread7[aggregateIds] = _objectSpread({}, (state[viewModelName] || {})[aggregateIds] || {}, (_objectSpread6 = {}, _objectSpread6[aggregateArgs] = viewModelState, _objectSpread6)), _objectSpread7)), _objectSpread10[_constants.connectorMetaMap] = _objectSpread({}, state[_constants.connectorMetaMap], (_objectSpread8 = {}, _objectSpread8[key] = {
      isLoading: false,
      isFailure: false
    }, _objectSpread8)), _objectSpread10[_constants.lastTimestampMap] = _objectSpread({}, state[_constants.lastTimestampMap], (_objectSpread9 = {}, _objectSpread9[key] = viewModelTimestamp, _objectSpread9)), _objectSpread10));
  };
  ...
  handlers[_action_types.LOAD_VIEWMODEL_STATE_FAILURE] = function (state, action) {
    ...
    var key = "" + viewModelName + aggregateIds + aggregateArgs;
    return _objectSpread({}, state, (_objectSpread12 = {}, _objectSpread12[_constants.connectorMetaMap] = _objectSpread({}, state[_constants.connectorMetaMap], (_objectSpread11 = {}, _objectSpread11[key] = {
      isLoading: false,
      isFailure: true,
      error: error
  ...
  var state = (_state = {}, _state[_constants.connectorMetaMap] = {}, _state[_constants.aggregateVersionsMap] = {}, _state[_constants.lastTimestampMap] = {}, _state);
