...
/*#__PURE__*/
_regenerator["default"].mark(function unsubscribeViewModelTopicsSaga(_ref) {
  ...
  return _regenerator["default"].wrap(function unsubscribeViewModelTopicsSaga$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 17:
          ...
          _context2.next = 20;
          return (0, _effects.put)((0, _actions.unsubscribeTopicRequest)(eventType, aggregateId));
            ...
            return _regenerator["default"].wrap(function _loop$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return (0, _effects.take)( // eslint-disable-next-line no-loop-func
                    function (action) {
                      return (action.type === _action_types.UNSUBSCRIBE_TOPIC_SUCCESS || action.type === _action_types.UNSUBSCRIBE_TOPIC_FAILURE) && subscriptionKeys.find(function (key) {
                  ...
                  case 2:
                    ...
                    if (unsubscribeResultAction.type === _action_types.UNSUBSCRIBE_TOPIC_SUCCESS) {
...
var _default = unsubscribeViewModelTopicsSaga;
