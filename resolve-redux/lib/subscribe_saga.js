      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (!(createSubscribeAdapter === _empty_subscribe_adapter["default"])) {
              _context.next = 3;
              break;
            }

            return _context.abrupt("return", (0, _empty_subscribe_adapter["default"])());
          ...
          case 5:
            ...
            onEvent = function onEvent(event) {
              return store.dispatch((0, _actions.dispatchTopicMessage)(event));
            };
...
var subscribeSaga =
/*#__PURE__*/
_regenerator["default"].mark(function subscribeSaga(subscribeSagaOptions) {
  var connectionManager, subscribeAdapterPromise;
  return _regenerator["default"].wrap(function subscribeSaga$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    _context2.next = 3;
                    return (0, _effects.delay)(SUBSCRIBE_ADAPTER_POLL_INTERVAL);
        ...
        case 4:
          _context5.next = 6;
          return (0, _effects.takeEvery)(_action_types.SUBSCRIBE_TOPIC_REQUEST,
          /*#__PURE__*/
            ...
            return _regenerator["default"].wrap(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  ...
                  case 8:
                    _context3.next = 10;
                    return (0, _effects.put)((0, _actions.subscribeTopicSuccess)(topicName, topicId));
                  ...
                  case 12:
                    ...
                    _context3.next = 16;
                    return (0, _effects.put)((0, _actions.subscribeTopicFailure)(topicName, topicId, _context3.t0));
        ...
        case 6:
          _context5.next = 8;
          return (0, _effects.takeEvery)(_action_types.UNSUBSCRIBE_TOPIC_REQUEST,
          /*#__PURE__*/
            ...
            return _regenerator["default"].wrap(function _callee4$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  ...
                  case 8:
                    _context4.next = 10;
                    return (0, _effects.put)((0, _actions.unsubscribeTopicSuccess)(topicName, topicId));
                  ...
                  case 12:
                    ...
                    _context4.next = 16;
                    return (0, _effects.put)((0, _actions.unsubscribeTopicFailure)(topicName, topicId, _context4.t0));
